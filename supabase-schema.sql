...
insert into public.portal_clients (id, name, contact_name, vertical) values
  ...
  ('client-astra', 'Astra Partners', 'Yannis SAHLI', 'ServiceNow Partner')
...
insert into public.portal_users (id, email, password_salt, password_hash, name, role, client_id) values
  ...
  ('user-astra-yannis', 'yannis.sahli@astra-conseil.com', 'salt-astra-yannis', '556227c5d01c3b33cd91c9c24828ecc1294c7e5cc6964fe0ce285cd7dccb2fcd', 'Yannis SAHLI', 'client', 'client-astra')
on conflict (id) do nothing;
